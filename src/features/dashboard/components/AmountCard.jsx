...
const AmountCard = ({ totalIncome, totalExpense, totalBalance }) => {
  ...
  return (
    <div className="flex grow-1 items-center p-5 gap-5 rounded-2xl bg-white/70">
      {/* total income */}
      <div className="flex px-8 py-5 bg-white/50 rounded-2xl items-center justify-between gap-2 w-full shadow-xl/10">
