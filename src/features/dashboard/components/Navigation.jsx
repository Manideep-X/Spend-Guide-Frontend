...
const Navigation = () => {
    ...
    return (
        <nav className={`flex flex-col items-center gap-3 md:p-5 p-4 justify-between overflow-hidden
            ...
            <section className="w-full flex flex-col md:gap-0 gap-4 overflow-y-scroll my-3 ml-2 thin-scrollbar-light">
                    ...
                    >
                        {/* Navigation isActive toggle */}
                        {
                            ({ isActive }) => 
                                ...
                                <div
                                    className="h-full flex items-center gap-4 px-8 py-3 rounded-xl transition-all shadow-[inset_2px_50px_40px_rgba(255,255,255,0.7)]"
                                >
                                    {/* Navigation icon */}
